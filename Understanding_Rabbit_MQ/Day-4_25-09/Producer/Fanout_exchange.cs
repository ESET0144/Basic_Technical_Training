...
{
    public class Fanout_exchange
    {
        private readonly ConnectionFactory _factory;
        private readonly string _exchangeName = "order.fanout";

        public Fanout_exchange(ConnectionFactory factory)
        {
            _factory = factory;
        }
        ...
        public async Task SendMessage(string message)
        {
            ...
            await channel.BasicPublishAsync(exchange: _exchangeName, routingKey: string.Empty, body: messageBody, mandatory: true);
        }
    }
}
